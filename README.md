game:GetService("StarterGui"):SetCore("SendNotification",{     
    ...
    local Win = VLib:Window("NEXOA", "MM2")
    ...
    local Main= Win:Tab('Murder Mystery')
    
    Main:Button("ESP",function()
    
        ---MONEY!
        loadstring(game:HttpGet('https://gist.githubusercontent.com/SadSality/85b627d0fd8fa9ee3941d771193ac056/raw/383278f1cc7354e7bfcb2940fca70ff37e97c587/Murder_Mystery_2-simple_ESP-edited_by_me.txt'))()
